...
%
% fibers = dtiFiberTracker(dt6, seedPoints, mmPerVox, ...
%               trackAlgo, interpAlgo, stepSize, faThresh, ...
%               angleThresh, wPuncture, lengthLim, xform)
%
% Inputs
...
%        The default method '1' most closely resembles the STT algorithm
%        described in Basser et. al., (2000),  In Vivo Fiber Tractography
%        Using DT-MRI Data, MRM.  It uses a Runge-Kutta path-integral
%        method.   
%
...
%    NOTE: TensorLines with a puncture coefficient of 1 is equivalent to
%          TEND. 
...
%     tracking when they reach this threshold. Ie., minLength is a filter
%     to get rid of short fibers, but maxlength is an additional stopping
