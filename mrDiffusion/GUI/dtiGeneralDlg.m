function outStruct = dtiGeneralDlg(uiStruct,pos,title)
%
% AUTHOR: ???
...
%
% BW, 12.15.00
% 2003.10.02 RFD: copied mrLoadRet 3.0 'generaldlg' to mrDiffusion.
% 2008.09.23 RFD: fixed bug that introduced spurious quotes
  ...
  switch uiStruct(uiNum).style
    ...
    %edit box
      if(~ischar(uiStruct(uiNum).value))
        valStr = mat2str(uiStruct(uiNum).value);
      else
        valStr = uiStruct(uiNum).value;
      end
