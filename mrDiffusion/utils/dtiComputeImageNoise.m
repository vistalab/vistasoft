...
if strcmp('corner', noiseCalcMethod)
    ...
    % See also Gudbjartsson & Patz (1995). The Rician Distribution of Noisy MRI Data
    % (http://www.ncbi.nlm.nih.gov/pmc/articles/PMC2254141/), where this term
    % is defined as 1/sqrt(2-pi/2) = 1.5264. Henkelman seems to have rounded off in
    % his calculations to get 1.5267. We'll compute the more accurate value here.
    sz = size(dwRaw.data);
    x  = 10;
    y  = 10;
    z  = round(sz(3)/2);
