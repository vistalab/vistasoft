function [Cnorm, Curv, Mu, Sigma] = dtiComputeFiberCurvatureDistribution(fg,displayDist)
...
%
% [Cnorm, Curv, Mu, Sigma]=dtiComputeFiberCurvatureDistribution(fg,displayDist)
%
% INPUTS:
...
%
% Outputs:
% Cnorm    = Normalized curvature of each fiber, in units of z-score.
% Curvature      = The curvature of each fiber.
%
