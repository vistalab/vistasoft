function [roiFile, labelFile] = roiSaveAllForItkGray(vw, fname)
...
% file. The nifti file can be read by itkGray.
%
% [roiFile, labelFile] = roiSaveForItkGray(vw, fname, roiColor)
%
% Oct 2008: JW
%
% See roiSaveForItkGray.m
