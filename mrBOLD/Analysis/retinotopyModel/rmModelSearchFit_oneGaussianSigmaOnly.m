function e = rmModelSearchFit_oneGaussianSigmaOnly(p,Y,XvYv,stim,t)
% rmModelSearchFit_oneGaussianSigmaOnly - actual fit function of rmSearchFit
%
...
% remove Xv Yv modifications outside this function for speed reasons
RF = exp( XvYv ./ (-2.*(p.^2)) );
