...
%   linked to MATLAB(R) or any compiled stand alone application.
  ...
  REVISION HISTORY:
  2007.04.12 Bob Dougherty (RFD): changed all comments to C-style ("/*") 
  to avoid errors when compiling on gcc versions that care.
...
#if defined(__WINDOWS__) || defined(WIN32) || defined(_MSC_VER)
