function view=fsl_doWithinScanMLRMotionCorrect(view,scansToProcess,newDataTypeName,forceOverwriteFlag)
% view=fsl_doWithinScanMLRMotionCorrect(view,scansToProcess,newDataTypeName,forceOverwriteFlag)
% PURPOSE: Motion corrects scans and replaces the time series in the
