function [functionals, hdr] = mrReadMagHeader(magFile)
% Read Efile headers associated with a mag file.
%
% [functionals, hdr] = mrReadMagHeader(magFile);
%
