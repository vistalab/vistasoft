...
% ras, 05/05: files generated by some code (e.g.,
% Jonas' TFI tools) doesn't appear to return a proper
% machineformat -- but reading w/ native format works.
% For now, if no format found, assume native:
