...
template<typename T>
void myCinterp3(double *vol,int nslice,int size1,int size2,int npts, T *x, double *f,double badval) {
...
void mexFunction(int nlhs,   /* number of arguments on lhs */
    ...
    int npts = 0;
    double *vol,*nslice,*size1,*size2,*f,badval;
    double *sagSize;
    ...
    if(mxIsDouble(prhs[3])) {
        ...
        myCinterp3(vol,(int) *nslice,(int) *sagSize,(int) *(sagSize+1),npts,x32,f,badval);
    }
}
