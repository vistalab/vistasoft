...
% inputmodel: The voxelwise diffusion model used for tracking. The default is 'dt', which means tensor model.
% fit_filename: The filename including the information of voxelwise diffusion model fit (e.g. tensor fit)
% pdfs_file: The output file describing the probability density function within the voxel used for PICo tracking
% 
