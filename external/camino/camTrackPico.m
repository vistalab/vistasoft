...
%               nifti file should the identical resolution and data matrix size with
%                 original dwi data.
% numiteration: The number of iteration in PICo
% pdfs_filename: The filename of probability density functions
% picotract_filename: The file name for streamline file in Bfloat format
% curv_thresh: curvature threshold
% stepsize: tracking step size
% curveinterval: The curvature threshold will not be applied if streamline length is shorter than curveinterval
% 
% For details of PICo Tracking parameter settings, please check Camino's website
% http://cmic.cs.ucl.ac.uk/camino//index.php?n=Man.Track
% 
