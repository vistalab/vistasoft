...
for jj = 1:length(tem.listRoi)
    ...
    tem.savePathSingle = '/biac4/wandell/data/reading_prf/forAnalysis/images/single/pRFDist/'; 
    tem.savePathGroup  = '/biac4/wandell/data/reading_prf/forAnalysis/images/group/pRFDist/'; 
    ...
    for ii = 1:length(tem.subjectsToAnalyze)
        ...
        rm = RM{iisub}; 
        tem.figHandle = ff_plotPRFDistribution(rm);
